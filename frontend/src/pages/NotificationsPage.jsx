...
export default function NotificationsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        eyebrow="2.5 Vaccination & Reminder System"
        title="Stay on top of vaccinations and follow-up checkups"
        description="This page surfaces the reminder types users should receive and lets them manage notification preferences."
      />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Notifications for vaccinations, follow-ups, and appointment reminders.</CardDescription>
          </CardHeader>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Automated reminder</p>
                    </div>
                  </div>
                  <Badge variant={item.tone === "warning" ? "warning" : "primary"}>{item.tone}</Badge>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Control how reminder updates are delivered.</CardDescription>
          </CardHeader>
