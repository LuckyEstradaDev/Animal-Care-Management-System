            ...
            {reminderItems.map((item, index) => (
              ...
              >
                ...
                <div className="flex justify-end gap-2">
                  <button className="bg-emerald-500 h-10 w-10 text-white text-xs font-semibold rounded-full cursor-pointer hover:bg-emerald-600">
                    ✓
                  </button>
                  <button className="bg-red-500 h-10 w-10 text-white text-xs font-semibold rounded-full cursor-pointer hover:bg-red-600">
                    🗑
                  </button>
                </div>
              </div>
